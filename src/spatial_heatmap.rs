...
impl Grid {
    fn new(width: u32, height: u32, cell_size: (u32, u32)) -> Self {
    ...
    fn increment_count(&mut self, point: &Point) {
        let cell_x = f64::ceil(point.x / self.cell_size.0 as f64) as usize;
        let cell_y = f64::ceil(point.y / self.cell_size.1 as f64) as usize;
